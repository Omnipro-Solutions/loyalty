...
/** Fila del picker: nombre + marca a la izquierda, SKU y precio de lista a la derecha — mismas columnas que ya se muestran en 03 · Catálogo. */
...
/** Filtro "Marca" para agregar en bloque desde el picker — mismo criterio de universo que ya usa la condición `producto_marca`. */
