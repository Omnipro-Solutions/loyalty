...
/** Duplicado de `features/promotions/lib/type-icon.ts`/`lib/labels.ts` por aislamiento entre features (CLAUDE.md §2) — mismo ícono/color/etiqueta que el módulo de Promociones, para que un tipo de promoción se vea igual en toda la app. */
